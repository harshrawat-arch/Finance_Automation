...
def process_revenue_report():
    try:
        ...
        if os.path.exists(RECOVERY_FILE):
            ...
            # Convert negative recovery amounts to positive for the formula logic
        ...
        # 1. Formula: net pg_payable = IF(Hold="Hold", 0, MAX(0, pg_payable2 - recovery))
        payment_df['net pg_payable'] = np.where(
            payment_df['Hold'] == "Hold", 
            0, 
        ...
        # 2. Formula: net cod_payable = IF(Hold="Hold", 0, MAX(0, cod_payable2 - pending_recovery))
        ...
        # --- 8. FINAL EXPORT (Main Data - No Logic Changes Here) ---
