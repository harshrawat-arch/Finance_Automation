...
def process_revenue_report():
    try:
        ...
        # Summing from payment sheet as requested
        ...
        extra_cols = ['MID_WID', 'Status', 'GMV', 'Commission', 'Tax', 'Seller Payable', 'Diff', 'merchant_id_name2', 'pg_payable2', 'cod_payable2']
        for col in extra_cols:
            if col not in final_cols: final_cols.append(col)

        df[final_cols].to_excel(OUTPUT_FILE, index=False)

        print("✅ SUCCESS — All files generated and Summary updated")
