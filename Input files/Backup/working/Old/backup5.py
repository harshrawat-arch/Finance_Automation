...
def process_revenue_report():
    try:
        ...
        to_num(['cust_shipping_reversal', 'partial_shipping_rev', 'pf_tax', 'pf_packing', 
        ...
        # Aggregate: Sum the numbers, take the first Merchant Name found for that ID
        ...
        print("-" * 40)
        print(f"✅ SUCCESS!")
        print(f"Summary saved with new columns to: {SUMMARY_FILE}")
        print("-" * 40)
