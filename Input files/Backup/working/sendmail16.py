...
def prepare_open_orders_email(date_display):
    ...
    requested_cols = [
        ...
        'total_price', 'item_status_text', 'discount', 'shipping_discount',
        'wallet_paid', 'pg_paid', 'cod_paid', 'shipping_amount', 'pf_tax', 'pf_packing', 
        'pf_seller_convenience', 'cart_conv_fee', 'vertical_name', 'product_id'
    ]
