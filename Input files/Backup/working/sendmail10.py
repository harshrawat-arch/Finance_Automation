...
def prepare_attachment_email(date_display):
    ...
    Please find attached payout files for checking.<br><br>
    Regards,<br>Finance Automation System</p>"""
    ...
    for filepath in files_to_attach:
        if os.path.exists(filepath):
            ...
            print(f"❌ Missing attachment: {filepath}")
...
def send_gmail():
    try:
        ...
        # NEW: ATTACHMENT MAIL
        msg4 = prepare_attachment_email(date_display)
