...
def process_revenue_report():
    try:
        ...
        # 7b. Map Hold from Hold_list.csv
        ...
        # 7c. Map Recovery from Recovery.csv (Matched on Merchant_ID)
        ...
        # Select exact headers for Payment Sheet
        ...
        print("-" * 40)
        print(f"✅ SUCCESS!")
        print(f"Files created in output_files folder.")
        print("-" * 40)
