...
def process_revenue_report():
    try:
        ...
        # Handle specific shipping and tax columns
        ...
        # --- 6. CREATE SUMMARY PIVOT TABLE (UPDATED) ---
        # Define numeric columns for the summary pivot
        summary_sum_cols = [
            ...
            'cust_shipping_reversal', 'partial_shipping_rev', 'mp_shipping'
        ]
        
        # Aggregate: Sum the metrics and retain the first merchant name for each MID_WID
